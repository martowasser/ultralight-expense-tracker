...
import { CreditCard, InstitutionOption, updateCreditCard } from "@/app/credit-cards/actions";
...
export default function EditCreditCardModal({
  ...
  const [institutionId, setInstitutionId] = useState(card.institutionId);
    ...
    <div className="fixed inset-0 bg-black/30 flex items-end sm:items-center justify-center z-50">
      <div className="bg-[#fafafa] w-full sm:max-w-[400px] sm:mx-4 max-h-[90vh] overflow-y-auto">
        <div className="px-6 py-4 border-b border-[#e5e5e5]">
          <h2 className="text-sm text-[#171717]">edit credit card</h2>
        </div>
